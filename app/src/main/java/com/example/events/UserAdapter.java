...
public class UserAdapter extends FirebaseRecyclerAdapter<MainModel,UserAdapter.myViewHolder> {

    public UserAdapter(@NonNull FirebaseRecyclerOptions<MainModel> options) {
        super(options);
    }
